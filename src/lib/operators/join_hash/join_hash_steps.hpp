...
// (2) Choosing an appropriate filter size. 2^21 was experimentally found to be good for TPC-H SF 10, but is certainly
...
static constexpr auto BLOOM_FILTER_SIZE = 1 << 21;
