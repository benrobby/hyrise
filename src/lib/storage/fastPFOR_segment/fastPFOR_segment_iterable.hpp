...
public:
    ...
    void _on_with_iterators(const Functor& functor) const {
      ...
      auto begin = Iterator{_segment.values(), _segment.null_values(), ChunkOffset{0}};
      auto end = Iterator{_segment.values(), _segment.null_values(), static_cast<ChunkOffset>(_segment.size())};
    ...
    void _on_with_iterators(const std::shared_ptr<PosListType>& position_filter, const Functor& functor) const {
      ...
      auto begin =
              PointAccessIterator<PosListIteratorType>{_segment.values(), _segment.null_values(),
