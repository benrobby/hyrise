...
# Sequential: Measure
mkdir -p sequential
./hyriseBenchmarkTPCH --encoding ../encoding_bitpacking_turbopfor.json --output sequential/BitCompression_result_sequential.json  -r 100 --dont_cache_binary_tables
